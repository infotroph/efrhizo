...
data: cleaned-up, finished, most authoritatize versions of datasets. Everything* here is generated by some scripted process, NEVER by hand-editing. 
	*EXCEPTION: as of 2016-01-07, subdirectory `2012` still contains hand-edited Excel spreadsheets: 4 of the 6 2012 tracing log files live here until I convert them to CSVs & add their untraceable images to the censored frames list. There are also two spreadsheets used to work out imagename corrections for 2012, which will probably live in `notes/` someday but maybe they need to be in a more useful format first.
