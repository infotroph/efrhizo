...
\section{Experiment setup}
	Open I-Cap and press ``Open an existing database.'' Select `EF2012(EHD).btc' and press ``Open''. If it opens without a hitch, enter your initials and check that the gather direction is DOWN, then move on to image capture.
	If I-Cap crashes with a `subscript out of range' message, set up a new experiment and we'll merge the images back into EF2012 later.
\begin{enumerate}
